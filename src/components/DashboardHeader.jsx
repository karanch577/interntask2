...
function DashboardHeader() {
  return (
    <div className='shadow-primary z-10 rounded-[15px] pt-2.5 pb-8'>
        ...
        <p className='text-[#C35AC7] text-center text-[10px]'>Purple tier</p>

      <DashboardPoints />

        <div className='text-[12px] flex justify-between items-center mx-3'>
            <p className='font-[600]'>Badges</p>
            <p className='opacity-30'>Open all</p>
        </div>
        <h2 className='text-[20px] font-[500] text-center'>Opened 38/120 badges</h2>
        <Badges />
    </div>
  )
}
